...
const StudentForm = ({ student, allRanks, studentStatuses, onSave, onChange, saving, errors, startDateChange, dobChange, lastTestDateChange}) => {
        ...
        <div className="row">
          <div className="col-sm-2">
            <SelectInput
              name="rankId"
              label="Rank"
              value={student.rankId.toString()}
              defaultOption="Select Rank"
              options={allRanks}
              onChange={onChange}
              error={errors.rankId} />
          </div>
