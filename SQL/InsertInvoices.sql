...
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(2, 'Month of Care', 4, 12.88, 1);
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(2, 'Snacks', 30, 1.50, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(2, 'Fun Time', 1, 100.67, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(3, 'Month of Care', 6, 12.88, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(3, 'Clothes', 10, 11.50, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(3, 'Transportation', 2, 32.95, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(4, 'Month of Care', 2, 12.88, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(4, 'Wait time', 10, 20.55, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(4, 'Transportation', 1, 32.95, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(5, 'Month of Care', 2, 12.88, 1)
INSERT INTO InvoiceLine (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(5, 'Snacks', 25, 1.50, 1)
INSERT INTO InvoiceLine  (InvoiceId, Description, Quantity, Cost, Paid)
	VALUES(5, 'Wait time', 4, 20.55, 1)
*/
